...
[![Version](https://img.shields.io/badge/Version-V0.01-30d158?style=flat-square)](https://github.com/hsb689/aipiPC/releases)
...
Grab the latest `AiPi-Heater-Upper-V0.01.exe` from [**Releases**](https://github.com/hsb689/aipiPC/releases) — portable, single file, no installation required.
