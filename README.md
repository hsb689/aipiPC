...
[![Version](https://img.shields.io/badge/版本-V0.2-30d158?style=flat-square)](https://github.com/hsb689/aipiPC/releases)
...
| 📋 | **通信日志** | 按等级着色(🔴 错误 🟢 连接 🌿 信息 🟠 数据 🔵 发送),数据日志与连接状态固定槽位替换,不刷屏 |
| 🎨 | **主题** | 跟随系统 / 浅色 / 深色 |
...
前往 [**Releases**](https://github.com/hsb689/aipiPC/releases) 下载最新版 `AiPi-Heater-Upper-V0.2.exe`,免安装、单文件运行。
